...
import plugin.java.com.plas.crashfilter.analysis.DefUseChain;
import plugin.java.com.plas.crashfilter.analysis.RDAnalysis;
...
public class ReturnValueAnalysis implements TaintSink {
    ...
    public ReturnValueAnalysis(List<DefUseChain.DefUseGraph> duGraphs, Function func,
                               ...
                               IStateVector<InstructionGraphNode, RDAnalysis.RDLatticeElement> RDResult, ILatticeGraph<InstructionGraphNode> graph) {
